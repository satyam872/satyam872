...
I turn data into insights using Excel, SQL, and Python.  
Passionate about business analytics and data-driven decisions.
...
### 🔹 Plant Injury Analysis Dashboard  
- Built using Excel (Pivot Tables, Charts)  
- Analyzed accident trends and cost impact  

### 🔹 Airport Flight Delay Analysis  
- Designed SQL database  
- Identified high-traffic routes and trends  
